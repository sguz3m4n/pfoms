...
<div class="row center-block">
    <div class="row">
        <div class="col-md-12">
            <div class="dashboard-stat dashboard-stat-v2 green" style="height: 140px">
                <div class="visual">
...
<!--                    <div class="row">
        ...
        <div class="col-md-4">          
 <label class="switch">
    <input type="checkbox" id="DayOff" name="DayOff">
    <div class="slider round"></div>
                    ...
                    <div class="col-md-3">
 <label class="switch">
    <input type="checkbox" id="OffDuty" name="OffDuty">
    <div class="slider round"></div>
                    ...
                    <div class="form-group" id="employee">
                        <div class="row" id="showlblPost">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="actingRateCode" id="actingRateCode"   />

                            </div>
                        </div>
                        <div class="row" id="showlblComments">
                            <br>
                            <div class="col-md-12">

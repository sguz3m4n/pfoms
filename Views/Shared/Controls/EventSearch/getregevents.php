...
//EventId, EventName, CompanyName, EventCost, EventDateStart, EventDateEnd, Comments, CompanyId, 
//Division, OperationalSupport, PoliceServices, VATPoliceServices,
//Status FROM event WHERE CompanyName = "' . $q . '" AND DelFlg="N" AND Status<>"Complete"';
...
<!--                   <button type="submit" class="btn btn-success" name="btn-submit" id="btnApprove"><strong>Submit Event</strong></button>-->
        ...
        <div class="col-md-6" style="display:none" id="divEventDetails"><br>
            ...
            <br>
<!--            <button class="accordion">Police Services</button>
<div class="panel">
  <p id="PS">testeatset</p>
</div>-->

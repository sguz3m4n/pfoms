...
class EditDutySheetController extends MakeProformaController {
...
class DutySheetTableController extends MakeProformaController {
...
//        $filterBy = array();
        ...
        if (isset($_REQUEST['dutysheetid'])) {
            $dutysheet = $_REQUEST['dutysheetid'];
            $dutysheetinst = new \PfomModel\DutySheet();
            $results = $dutysheetinst->GetListDutySheet($dutysheet);
...
//                    } else {
                    ...
                    $EditButton = "<td><button type='button' class='btn btn-info btn-sm edit' data-toggle='modal' id=" . $value["DutySheetId"] . ">Officer</button></td>";
                    $EditButton2 = "<td><button type='button' class='btn btn-info btn-sm edit2' data-toggle='modal' id=" . $value["DutySheetId"] . ">Support</button></td>";
                    $OfficerAmend = "<td><button type='button' class='btn btn-info btn-sm amend' data-toggle='modal' data-target='#officermodal' id=" . $value["DutySheetId"] . ">Officer</button></td>";
                    $SupportAmend = "<td><button type='button' class='btn btn-info btn-sm amend' data-toggle='modal' data-target='#supportmodal' id=" . $value["DutySheetId"] . ">Support</button></td>";
//                    }

                    $table = $table . "<tr" . $rowClass . "><td>" . $value["CompanyName"] . "</td><td>" . $value["DutyDate"] . "</td>"
                            . "<td>" . $value["DispatchTime"] . "</td><td>" . $value["ReturnTime"] . "</td><td>"
            ...
            $template->load("Views/DutySheet/table.html");

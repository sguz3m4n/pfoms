        ...
        <div class="col-md-12">
            <div class="dashboard-stat dashboard-stat-v2 green" >
                ...
                <div class="details">
                    ...
                    <div class="desc" id="submitterequipmentname"><span class="glyphicon glyphicon-barcode"></span><?php echo $equipinst->EquipmentId; ?></div>
                    <div class="desc" id=""><?php echo $equipinst->ItemName; ?></div>
                </div>
            </div>
        </div> 
    </div>
        ...
        <div class="col-md-12">
            <div class="dashboard-stat dashboard-stat-v2 blue" >
                ...
                <div class="details">
                    ...
                    <div class="desc"> Equipment Cost per <?php echo $equipinst->UnitMeasurement; ?></div>
                </div>
            </div>
        </div> 
    </div>
